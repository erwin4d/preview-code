function [prop_arr] = find_ests_prop(true_sim, est_sim, is_diag, val_vec)
  ...
  for val_num = 1:length(val_vec);
    ...
    if val_num == 1
      ...
      true_pos_idx = bitand((true_val < val_vec(val_num)) , (true_val >= val_vec(val_num-1)))   ;
      est_pos_idx = bitand((est_val < val_vec(val_num)) ,(est_val >= val_vec(val_num-1))) ;      
    end
